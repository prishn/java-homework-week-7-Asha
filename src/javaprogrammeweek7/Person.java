 ...
 * TEST EXAMPLE
 * TEST CODE: (Write below code in to main method then check out put) Person person = new Person(); person.setFirstName("");
 * // firstName is set to empty string person.setLastName("");
 * // lastName is set to empty string person.setAge(10);
 * System.out.println("fullName= " + person.getFullName()); System.out.println("teen= " + person.isTeen()); person.setFirstName("John");
 * // firstName is set to John person.setAge(18);
 * System.out.println("fullName= " + person.getFullName()); System.out.println("teen= " + person.isTeen()); person.setLastName("Smith");
...
public class Person {
    ...
    // Method to check if person is teen
